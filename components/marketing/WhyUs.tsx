...
export default function WhyUs() {
  ...
  return (
    <section className="bg-dark-950 py-24 border-t border-dark-900">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar, idx) => (
            <div
              key={idx}
              className="p-8 bg-dark-900 border border-dark-800 hover:border-gold-500/20 rounded-sm transition-all duration-300 flex flex-col items-start hover:shadow-xl hover:shadow-gold-500/5 group"
            >
              <div className="p-3 bg-dark-950 rounded-sm mb-6 border border-dark-800 group-hover:border-gold-500/20 transition-colors">
                {pillar.icon}
              </div>
